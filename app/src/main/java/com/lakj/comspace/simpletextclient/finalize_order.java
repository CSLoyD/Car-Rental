...
public class finalize_order extends Activity {
    ...
    public void show_Order() {
        ...
        if (Starters.veg_crispy > 0) {
            fin_order_string = fin_order_string + "Honda City - for " + String.valueOf(Starters.veg_crispy) + " Hours" + "\n";
        }
        if (Starters.chicken_crispy > 0) {
            fin_order_string = fin_order_string + "Honda Civic - for " + String.valueOf(Starters.chicken_crispy) + " Hours" + "\n";
        }
        if (Starters.paneer_chilly > 0) {
            fin_order_string = fin_order_string + "Honda BR-V - for " + String.valueOf(Starters.paneer_chilly) + " Hours" + "\n";
        }
        ...
        if (Starters.veg_soup > 0) {
            fin_order_string = fin_order_string + "Honda BR-V - for " + String.valueOf(Starters.veg_soup) + " Hours" + "\n";
        }
...
//                              + "\nCustomer note: " + personal_preferances;
                        ...
                        PendingIntent pi=PendingIntent.getActivity(getApplicationContext(), 0, nextact,0);
                            ...
                            String no = SlimpleTextClientActivity.uNum;
