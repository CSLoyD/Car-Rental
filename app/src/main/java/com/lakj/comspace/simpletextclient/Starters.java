...
public class Starters extends Activity {
    ...
    {
        starters_total=veg_crispy*(65)+chicken_crispy*(87)+veg_soup*(70)+paneer_chilly*(70)+masala_papad*(30)+chicken_soup*(80)+tomato_soup*(100)+cheese_pakoda*(130)+paneer_pakoda*(140)+chicken_chilly*(120);
